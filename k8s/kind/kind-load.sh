...
docker pull z9shay/new-api-gateway:latest
docker pull z9shay/new-product-service:latest
docker pull z9shay/new-order-service:latest
docker pull z9shay/new-inventory-service:latest
docker pull z9shay/new-notification-service:latest
...
kind load docker-image -n microservices z9shay/new-api-gateway:latest
kind load docker-image -n microservices z9shay/new-product-service:latest
kind load docker-image -n microservices z9shay/new-order-service:latest
kind load docker-image -n microservices z9shay/new-inventory-service:latest
kind load docker-image -n microservices z9shay/new-notification-service:latest
